...
namespace PortlandCompressor.Plugin.Widgets.GA4.Components
{
    public class GA4ViewComponent : NopViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData = null)
        {
            ...
            if (IsPurchase())
            {
                ...
                var currentOrder = await _orderService.SearchOrdersAsync(customerId:currentCustomer.Id, pageSize: 1);
                var orderId = currentOrder.FirstOrDefault().Id;
                ...
                model.PurchaseModel = new PurchaseModel()
                {
                    ...
                    Value = order.OrderSubtotalExclTax,
        ...
        private bool IsPurchase()
        {
            ...
            var orderId = routeData.Values["orderId"];
        ...
        private bool IsBeginCheckout()
        {
            ...
            var controller = routeData.Values["controller"];
            var action = routeData.Values["action"];
            return controller.Equals("Checkout") && action.Equals("OnePageCheckout");
        }
