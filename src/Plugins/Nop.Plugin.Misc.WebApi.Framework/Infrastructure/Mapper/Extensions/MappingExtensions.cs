...
public static class MappingExtensions
{
    ...
    {
        return entity == null ? throw new ArgumentNullException(nameof(entity)) : entity.Map<TBaseJsonDto>();
    }
    ...
    {
        return dto == null ? throw new ArgumentNullException(nameof(dto)) : dto.Map<TEntity>();
    }
